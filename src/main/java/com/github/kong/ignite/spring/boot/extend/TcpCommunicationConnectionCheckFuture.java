...
public class TcpCommunicationConnectionCheckFuture extends GridFutureAdapter<BitSet> implements IgniteSpiTimeoutObject, GridLocalEventListener {
    ...
    /** */
    private static final AtomicIntegerFieldUpdater<TcpCommunicationConnectionCheckFuture.SingleAddressConnectFuture> connFutDoneUpdater =
            AtomicIntegerFieldUpdater.newUpdater(TcpCommunicationConnectionCheckFuture.SingleAddressConnectFuture.class, "done");

    /** */
    private static final AtomicIntegerFieldUpdater<TcpCommunicationConnectionCheckFuture.MultipleAddressesConnectFuture> connResCntUpdater =
            AtomicIntegerFieldUpdater.newUpdater(TcpCommunicationConnectionCheckFuture.MultipleAddressesConnectFuture.class, "resCnt");
    ...
    /** */
    private volatile TcpCommunicationConnectionCheckFuture.ConnectFuture[] futs;
    ...
    public void init(long timeout) {
        TcpCommunicationConnectionCheckFuture.ConnectFuture[] futs = new TcpCommunicationConnectionCheckFuture.ConnectFuture[nodes.size()];
        ...
        for (int i = 0; i < nodes.size(); i++) {
            ...
            if (!node.id().equals(locId)) {
                ...
                if (addrs.size() == 1) {
                    TcpCommunicationConnectionCheckFuture.SingleAddressConnectFuture fut = new TcpCommunicationConnectionCheckFuture.SingleAddressConnectFuture(i);
                    ...
                    TcpCommunicationConnectionCheckFuture.MultipleAddressesConnectFuture fut = new TcpCommunicationConnectionCheckFuture.MultipleAddressesConnectFuture(i);
    ...
    @Override public void onEvent(Event evt) {
        ...
        for (int i = 0; i < nodes.size(); i++) {
            if (nodes.get(i).id().equals(nodeId)) {
                TcpCommunicationConnectionCheckFuture.ConnectFuture fut = futs[i];
    ...
    @Override public void onTimeout() {
        ...
        TcpCommunicationConnectionCheckFuture.ConnectFuture[] futs = this.futs;
     ...
     *
     */
    private class SingleAddressConnectFuture implements TcpCommunicationNodeConnectionCheckFuture, TcpCommunicationConnectionCheckFuture.ConnectFuture {
        /** */
        final int nodeIdx;
     ...
     *
     */
    private class MultipleAddressesConnectFuture implements TcpCommunicationConnectionCheckFuture.ConnectFuture {
        /** */
        volatile int resCnt;

        /** */
        volatile TcpCommunicationConnectionCheckFuture.SingleAddressConnectFuture[] futs;
        ...
        /** {@inheritDoc} */
        @Override public void onNodeFailed() {
            TcpCommunicationConnectionCheckFuture.SingleAddressConnectFuture[] futs = this.futs;
        ...
        void init(Collection<InetSocketAddress> addrs, Object consistentId, UUID rmtNodeId) {
            TcpCommunicationConnectionCheckFuture.SingleAddressConnectFuture[] futs = new TcpCommunicationConnectionCheckFuture.SingleAddressConnectFuture[addrs.size()];

            for (int i = 0; i < addrs.size(); i++) {
                TcpCommunicationConnectionCheckFuture.SingleAddressConnectFuture fut = new TcpCommunicationConnectionCheckFuture.SingleAddressConnectFuture(nodeIdx) {
        ...
        private void cancelFutures() {
            ...
            if (futs != null) {
                for (int i = 0; i < futs.length; i++) {
                    TcpCommunicationConnectionCheckFuture.SingleAddressConnectFuture fut = futs[i];
